...
const ProductSearch = ({ setSearch }: Props) => {
    return (
        <div className="flex justify-between mx-5">
            <form className="max-w-lg mx-auto">
                ...
                <div className="relative">
                    ...
                    className="block w-150 rounded-full h-15 p-3 ps-9 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand shadow-xs placeholder:text-body" placeholder="Search" required />
